  ...
  const handleBookingClick = () => {
    ...
    return (
      ...
      text-center bg-red-200 text-black font-bold text-4xl">
                        <h3 className="text-4xl font-bold pl-8 pr-8">STANDARD CAR SERVICE</h3>
                ...
                <div className='relative mt-8'>
                        ...
                        <div className='flex flex-col md:flex-row md:gap-20 gap-8'>
                            ...
                            <div className="not-included-price gap-4">
                                <div className="not-included">
                                    ...
                                    <span className='ml-1'>Throttle Body Cleaning</span>
                                    <br />
                                    <ClearIcon style={{ color: 'red' }} />
                                    <span className='ml-1'>Tyre Rotation</span>
                                    <br />
                                    <ClearIcon style={{ color: 'red' }} />
                                    <span className='ml-1'>AC Filter Replacement</span>
                                    <br />
                                    <ClearIcon style={{ color: 'red' }} />
                                    <span className='ml-1'>Gear Oil Top-Up</span>
                                    <br />
                                    <ClearIcon style={{ color: 'red' }} />
                                    <span className='ml-1'>Front Brake Pads Cleaning</span>
                                    <br />
                                    <ClearIcon style={{ color: 'red' }} />
                                    <span className='ml-1'>Engine Flushing</span>
                                    <br />
                                    <ClearIcon style={{ color: 'red' }} />
                                    <span className='ml-1'>Wheel Balancing</span>
                                    <br />
                                    <ClearIcon style={{ color: 'red' }} />
                                    <span className='ml-1'>Wheel Alignment</span>
                                    <br />
                                    <ClearIcon style={{ color: 'red' }} />
                    ...
                    <div className="overlap-price text-center bg-green-800 p-6 rounded-3xl shadow-md animate-blinkRed-shadow
                        ...
                        <span className='text-white text-lg '>GET FREE OIL AND AED 150 OFF</span>
                        <br />
                        ...
                        <div className="container text-center mt-5">
                            <button onClick={handleBookingClick} className="text-lg font-bold shadow-lg shadow-white bg-red-700 text-white p-2 rounded-lg ">BOOK NOW</button>
                        </div>
